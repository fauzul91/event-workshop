    ...
    <section id="Content" class="w-full max-w-[1280px] mx-auto px-[52px] mt-16 mb-[100px]">
        <div class="flex flex-col gap-16">
            ...
            <main class="flex gap-8">
                    ...
                    <div class="flex flex-col gap-4">
                        ...
                        <div class="card-detail flex flex-col gap-2">
                            <div class="flex items-center gap-3">
                                ...
                                <div class="flex items-center gap-1">
                                    <img src="{{ asset(
                                    'assets/images/icons/timer.svg') }}" class="w-6 h-6 flex shrink-0" alt="icon">
                    ...
                    <div id="closes-section" class="accordion flex flex-col gap-8 transition-all duration-300 mt-8 group-has-[:checked]:mt-0 group-has-[:checked]:!h-0 overflow-hidden">
                        ...
                        <div class="flex flex-col gap-4">
                            ...
                            <div class="flex flex-col gap-6">
                                ...
                                @empty
                                    <p>Belum ada benefit yang tersedia</p>                                    
                                @endforelse
                            </div>
                        </div>
                        <div class="flex flex-col gap-4">
                            ...
                            <div class="flex flex-col gap-4 rounded-xl border border-[#E6E7EB] p-5 pb-[21px]">
                                <div class="flex w-full h-[180px] rounded-xl overflow-hidden">
                                    <img src="{{ Storage::url($workshop->bg_map) }}" class="w-full h-full object-cover" alt="location">
                                </div>
                ...
                <form id="Form" method="POST" action="{{ route('front.payment_store') }}" class="flex flex-col w-[724px] gap-8" enctype="multipart/form-data">
                    @csrf
                            ...
                            <div class="flex flex-col gap-6">
                                <label class="flex flex-col gap-4">
                                    ...
                                    <div class="group input-wrapper flex items-center rounded-xl p-4 gap-2 bg-[#FBFBFB] overflow-hidden">
                                        ...
                                        <input type="text" name="customer_bank_name" id="customer_bank_name" class="appearance-none bg-transparent w-full outline-none text-lg leading-[27px] font-semibold placeholder:font-medium placeholder:text-aktiv-grey" placeholder="What is the name of the bank you use?" required>
                                    </div>
                                </label>
                                <label class="flex flex-col gap-4">
                                    ...
                                    <div class="group input-wrapper flex items-center rounded-xl p-4 gap-2 bg-[#FBFBFB] overflow-hidden">
                                        ...
                                        <input type="text" name="customer_bank_account" id="customer_bank_account" class="appearance-none bg-transparent w-full outline-none text-lg leading-[27px] font-semibold placeholder:font-medium placeholder:text-aktiv-grey" placeholder="Under whose name is this bank account?" required>
                                    </div>
                                </label>
                                <label class="flex flex-col gap-4">
                                    ...
                                    <div class="group input-wrapper flex items-center rounded-xl p-4 gap-2 bg-[#FBFBFB] overflow-hidden">
                                        ...
                                        <input type="text" name="customer_bank_number" id="customer_bank_number" class="appearance-none bg-transparent w-full outline-none text-lg leading-[27px] font-semibold placeholder:font-medium placeholder:text-aktiv-grey" placeholder="What is the bank account number?" required>
                                    </div>
                                </label>
                            </div>
                        </div>
