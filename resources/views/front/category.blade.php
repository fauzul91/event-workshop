        ...
        <div class="flex flex-col gap-9">
            <div class="flex flex-col items-center gap-1">
                ...
                <div class="flex items-center gap-2 ">
                    ...
                    <span>></span>
                    <a class="font-medium text-aktiv-grey last:font-semibold last:text-aktiv-black">Category
                        {{ $category->name }}</a>
                </div>
            </div>
            <div class="grid grid-cols-3 gap-6">
                ...
                @empty
                    <p class="text-lg font-medium text-gray-500">Belum ada workshop tersedia</p>
                @endforelse
            </div>
        </div>
    </section>
