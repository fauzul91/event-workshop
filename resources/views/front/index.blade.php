    ...
    <section id="Categories" class="w-full max-w-[1280px] mx-auto px-[52px] mt-[100px]">
        <div class="flex flex-col gap-8">
            ...
            <div class="grid grid-cols-4 gap-6">
                ...
                @empty
                    <p class="flex items-center justify-center mx-auto text-center">Belum ada kategori tersedia</p>
                @endforelse
            </div>
        </div>
    </section>
    <section id="Trending" class="w-full max-w-[1280px] mx-auto px-[52px] mt-[100px]">
        <div class="flex flex-col gap-8">
            ...
            <div class="grid grid-cols-3 gap-6">
                                ...
                                <div class="card-detail flex flex-col gap-2">
                                    <div class="flex items-center gap-3">
                                        <div class="flex items-center gap-1">
                                            ...
                                            <span
                                                class="font-medium text-aktiv-grey">{{ \Carbon\Carbon::parse($itemNewWorkshop->started_at)->format('d M Y') }}
                                            </span>
                                        </div>
                                        <div class="flex items-center gap-1">
                                            <img src="{{ asset('assets/images/icons/timer.svg') }}"
                                                class="w-6 h-6 flex shrink-0" alt="icon">
                                            <span
                                                class="font-medium text-aktiv-grey">{{ \Carbon\Carbon::parse($itemNewWorkshop->time_at)->format('H:i') }}
                                            </span>
                                        </div>
                                    </div>
                                    <h3
                            ...
                            <div class="flex items-center justify-between">
                                <div class="flex items-center gap-[6px]">
                                    <p class="font-semibold text-2xl leading-8 text-aktiv-red">
                                        Rp{{ number_format($itemNewWorkshop->price, 0, ',', '.') }}</p>
                ...
                @empty
                    <p class="text-center mx-auto">Belum ada workshop tersedia.</p>
                @endforelse
            </div>
        </div>
    </section>
                ...
                <div class="swiper w-full">
                        ...
                        <div class="swiper-slide">
                            <div
                                ...
                                <div class="flex h-full w-[436px] shrink-0 bg-aktiv-orange overflow-hidden">
                                    <img src="assets/images/photos/testimony1.png" class="w-full h-full object-cover"
                                        alt="photo">
                                </div>
                                <div
                                    ...
                                    <div class="flex justify-between items-center">
                                        ...
                                        <div class="flex items-center">
                                            <img src="assets/images/icons/Star 1.svg" class="p-[5px] w-8 h-8"
                                                alt="star">
                                            <img src="assets/images/icons/Star 1.svg" class="p-[5px] w-8 h-8"
                                                alt="star">
                                            <img src="assets/images/icons/Star 1.svg" class="p-[5px] w-8 h-8"
                    ...
                    <div class="absolute w-full max-w-[1244px] mx-auto left-1/2 top-1/2 transform -translate-x-1/2 z-10">
                        ...
                        <div class="swiper-button-next !w-12 !h-12 rounded-full after:hidden">
                            <img src="assets/images/icons/arrow-left.svg" class="w-full h-full rotate-180"
                                alt="icon">
                        </div>
                    </div>
                </div>
            ...
            <div class="flex flex-col gap-8">
                ...
                <div class="grid grid-cols-3 gap-6">
                    ...
                    <div
                        class="flex flex-col h-full justify-between rounded-3xl border border-[#E6E7EB] p-6 gap-3 bg-white">
                        <div class="flex items-center gap-3">
                            <img src="assets/images/icons/Learning Flexibility.png"
                                class="flex w-[56px] h-[56px] shrink-0" alt="icon">
